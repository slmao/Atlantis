...
constexpr std::string_view kVersionLine = "atlantis_material_metadata_version: 3";
...
// clearcoat_roughness, same unconditional-presence discipline.
constexpr std::size_t kExpectedLineCount = 11;
