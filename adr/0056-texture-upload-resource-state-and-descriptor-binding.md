...
- **Acceptance Record (2026-08-24):** Accepted by Human Review as part
  ...
  note (Human Review Decision items 5, 6, 7, 8, 13, 17) for the specific
  items this ADR corresponds to, including the combined-submission
  design (item 6) and the `expectedContract` wiring fix (item 17). This
