...
[resource_lifetime.md](../architecture/resource_lifetime.md) also
...
- **Both are move-only, single-owner RAII types**, held exclusively behind
  ...
  This resolves [resource_lifetime.md](../architecture/resource_lifetime.md)'s
...
- Answers [resource_lifetime.md](../architecture/resource_lifetime.md)'s
