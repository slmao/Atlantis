...
- No CI pipeline exists (confirmed: no `.github/workflows/` directory in
  this repository) — see
  [docs/process/ci-strategy.md](../process/ci-strategy.md). Today's
...
[ci-strategy.md](../process/ci-strategy.md)'s existing "Image
...
layered per
[testing-strategy.md](../process/testing-strategy.md)'s own layer
...
[ci-strategy.md](../process/ci-strategy.md) already logs as open
