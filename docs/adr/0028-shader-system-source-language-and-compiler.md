...
[docs/architecture/module_boundaries.md](../architecture/module_boundaries.md#atlantis-shader-system)
...
- **SPIR-V version target: SPIR-V 1.0, selected explicitly via
  ...
  **`-warnings-disable 50011`**, suppressing exactly this one, known,
  ...
  [docs/process/definition-of-done.md](../process/definition-of-done.md)'s
