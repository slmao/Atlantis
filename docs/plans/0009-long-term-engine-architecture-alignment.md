...
- [docs/architecture/module_boundaries.md](../architecture/module_boundaries.md)
  and [docs/architecture/overview.md](../architecture/overview.md) —
...
- [docs/project-blueprint.md](../project-blueprint.md) — current
...
Per [docs/process/definition-of-done.md](../process/definition-of-done.md),
