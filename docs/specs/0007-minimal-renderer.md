...
- **`Renderer` itself has no concrete shape** —
  [module_boundaries.md](../architecture/module_boundaries.md) and
  [resource_lifetime.md](../architecture/resource_lifetime.md) fixed
...
[module_boundaries.md](../architecture/module_boundaries.md) already
...
- **Headless integration tests:** not applicable — headless rendering remains
  unimplemented, per
  [testing-strategy.md](../process/testing-strategy.md)'s sequencing note;
...
- **Whether a GPU-integration test category distinct from the existing
  ...
  [testing-strategy.md](../process/testing-strategy.md)'s existing layer
