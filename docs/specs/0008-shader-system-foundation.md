...
[docs/project-blueprint.md](../project-blueprint.md)'s Milestone 5
...
- New module `src/shader_system/`, target `atlantis_shader_system`, alias
  ...
  [module_boundaries.md](../architecture/module_boundaries.md#atlantis-shader-system)
...
- New executable target (e.g. `atlantis_shader_compiler`) under
  `src/tools/`, realizing
  [module_boundaries.md](../architecture/module_boundaries.md#atlantis-tools)'s
...
- **The RHI-shape mapping lives in a secondary integration target inside
  ...
  `AGENTS.md` nor
  [module_boundaries.md](../architecture/module_boundaries.md) is
