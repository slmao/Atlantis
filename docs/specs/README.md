...
| 0034 | [Android Platform and Vulkan Presentation](0034-android-platform-vulkan-presentation.md) | Approved (2026-09-12, chat; docs merged [PR #157](https://github.com/slmao/Atlantis/pull/157)) | [Plan 0034](../plans/0034-android-platform-vulkan-presentation.md) (Approved; Joint Review recorded) | Merged: [PR #158](https://github.com/slmao/Atlantis/pull/158) | Depends on 0002, 0003; formerly Candidate Order 1 (below). Four new decisions recorded as `Accepted` ADR-0077–ADR-0080 (same basis). |
| 0035 | [Clearcoat, Sheen, and Anisotropy PBR Materials](0035-clearcoat-sheen-anisotropy-materials.md) | Approved | [Plan 0035](../plans/0035-clearcoat-sheen-anisotropy-materials.md) (Approved) | Merged: [PR #160](https://github.com/slmao/Atlantis/pull/160), [PR #161](https://github.com/slmao/Atlantis/pull/161) | Extends 0023's `MaterialKind` surface as three separately-schema-bumped milestones; [ADR-0081](../adr/0081-pbr-material-brdf-extension-clearcoat-sheen-anisotropy.md). |
| 0036 | [Bistro Parity Roadmap](0036-bistro-parity-roadmap.md) | Approved | None — roadmap-stage; each workflow owns its own Spec/Plan | Per workflow: ① merged ([PR #167](https://github.com/slmao/Atlantis/pull/167)) | Depends on 0023–0031. Decides nothing itself; amended 2026-09-19 to add workflows ①b ([Spec 0039](0039-rhi-index-type-parameterization.md)) and ①c. |
| 0037 | [glTF 2.0 Importer](0037-gltf-importer.md) | Approved | [Plan 0037](../plans/0037-gltf-importer.md) (Approved) | Merged: [PR #167](https://github.com/slmao/Atlantis/pull/167) | Spec 0036 workflow ①; [ADR-0082](../adr/0082-gltf-parser-dependency-selection.md), [ADR-0083](../adr/0083-gltf-to-atlantis-asset-format-mapping.md), [ADR-0084](../adr/0084-gltf-importer-tools-subsystem-boundary.md). Its `.amesh` v5 artifacts cannot be rendered until 0039 lands (Plan 0037 Ruling 5). |
| 0038 | [Block-Compressed Texture Support](0038-block-compressed-textures.md) | Approved | [Plan 0038](../plans/0038-block-compressed-textures.md) (Approved) | Merged: [PR #165](https://github.com/slmao/Atlantis/pull/165) | BC7 sampled-texture format and Vulkan mapping; [ADR-0085](../adr/0085-block-compressed-sampled-texture-format-and-vulkan-mapping.md). Mip-chain passthrough deferred to Spec 0036 workflow ①c. |
| 0039 | [RHI Index-Type Parameterization (uint16/uint32)](0039-rhi-index-type-parameterization.md) | Approved (2026-09-20, chat; docs merged [PR #168](https://github.com/slmao/Atlantis/pull/168)) | [Plan 0039](../plans/0039-rhi-index-type-parameterization.md) (Approved; Joint Review recorded) | Merged: [PR #170](https://github.com/slmao/Atlantis/pull/170) — v5 meshes renderable, Ruling 5 closed | Spec 0036 workflow ①b; depends on 0037's v5 artifacts, hard dependency of workflow ⑦. [ADR-0086](../adr/0086-rhi-index-type-public-expression-and-backward-compatibility.md), [ADR-0087](../adr/0087-asset-system-index-width-representation-and-artifact-version-dispatch.md) (both `Accepted`). |
| 0040 | [Multi-Light Architecture](0040-multi-light-architecture.md) | Approved (2026-09-21, chat; docs merged [PR #171](https://github.com/slmao/Atlantis/pull/171)) | [Plan 0040](../plans/0040-multi-light-architecture.md) (Approved; Joint Review recorded; merged [PR #172](https://github.com/slmao/Atlantis/pull/172)) | Merged: [PR #173](https://github.com/slmao/Atlantis/pull/173) — 64 point lights, 11/11 reflection cross-check, `multi_light_demo` golden | Spec 0036 workflow ②; widens the point-light cap 4 → 64 in one uniform buffer, froxel/clustered rejected-for-now with its reopening condition recorded. [ADR-0088](../adr/0088-frame-lighting-data-successor-structure-and-binding-strategy.md) (`Accepted`). Plan 0037 Ruling 8's photometric obligation reassigned to a future separate Spec. |
| 0041 | [Emissive Materials](0041-emissive-materials.md) | Approved (2026-09-22, chat; docs merged [PR #174](https://github.com/slmao/Atlantis/pull/174)) | [Plan 0041](../plans/0041-emissive-materials.md) (Approved; Joint Review recorded; merged [PR #175](https://github.com/slmao/Atlantis/pull/175)) | Merged: [PR #176](https://github.com/slmao/Atlantis/pull/176) — schema v7, ten shaders, `emissive_demo` golden | Spec 0036 workflow ③; factor-only `emissiveFactor` (linear, `[0, 65504]`) on the four PBR kinds, schema 6 → 7; emissive texture deferred to workflow ⑦'s measured need. [ADR-0089](../adr/0089-emissive-material-parameter-range-composition-and-push-constant-placement.md) (`Accepted`). |
| 0042 | [Transparency](0042-transparency.md) | Approved (2026-09-23, chat; docs merged [PR #178](https://github.com/slmao/Atlantis/pull/178)) | [Plan 0042](../plans/0042-transparency.md) (Approved; Joint Review recorded; merged [PR #179](https://github.com/slmao/Atlantis/pull/179)) | Merged: [PR #180](https://github.com/slmao/Atlantis/pull/180) — schema v8, alpha-test `discard` in ten shaders, back-to-front blend sort, `cutout_demo` and `transparency_demo` goldens | Spec 0036 workflow ④; alpha test (`MASK`) and alpha blend (`BLEND`) on the four PBR kinds, schema 7 → 8; blended draws sorted back-to-front inside `drawFrame()` and never write depth. [ADR-0090](../adr/0090-transparency-blend-state-draw-order-and-depth-write.md) (`Accepted`) — RHI `ColorBlendMode`, draw order, depth-write policy. Bistro's transmission glass deferred to ⑦ (ruling O3). |
| 0043 | [Height Fog](0043-height-fog.md) | Approved (2026-09-24, chat; docs merged [PR #181](https://github.com/slmao/Atlantis/pull/181)) | [Plan 0043](../plans/0043-height-fog.md) (Approved; Joint Review recorded; merged [PR #182](https://github.com/slmao/Atlantis/pull/182)) | Merged: [PR #183](https://github.com/slmao/Atlantis/pull/183) — scene source/artifact v5, 32-byte `FogData` camera-uniform tail, fog term in ten shaders, `fog_distance_demo`/`fog_height_demo`/`fog_dark_demo` goldens | Spec 0036 workflow ⑤; analytic exponential height fog as a per-fragment term in the ten PBR shaders, in HDR space (no new pass); parameters from optional camera-node scene tokens (scene source v4 → v5) into a 32-byte `FogData` tail on the camera uniform; density 0 is an exact identity. [ADR-0091](../adr/0091-height-fog-insertion-point-uniform-layout-and-parameter-source.md) (`Accepted`) — insertion point, fog model, uniform layout, parameter source. Sky left unfogged for ⑦ (ruling Q4). |
| 0044 | [Bloom](0044-bloom.md) | Approved (2026-09-24, chat confirmation; reviewed in this Spec's own branch PR) | None yet — Plan drafting authorized | Not started | Spec 0036 workflow ⑥; HDR bright-pass (parameterised knee, Filament's formula) into a fixed six-level downsample/upsample chain from half resolution, then a separate composite pass (`hdr + strength · bloom / 6`) that the output transform reads in place of `hdr_color`; reads already-fogged HDR; no RHI, Vulkan Backend or RenderGraph change. Parameters from an optional camera-node `bloom=` group (scene source v5 → v6); absent is off, no pass declared. [ADR-0092](../adr/0092-bloom-pass-insertion-blur-strategy-targets-and-parameter-source.md) (`Accepted`) — pass insertion, blur strategy, intermediate targets, parameter source. ADR-0068 D-10 untouched (ruling Q2). |
