...
| 0041 | [Emissive Materials](0041-emissive-materials.md) | Approved (2026-09-22, chat confirmation; reviewed in this Spec's own branch PR) | None yet — Plan drafting authorized | Not started | Spec 0036 workflow ③; factor-only `emissiveFactor` (linear, `[0, 65504]`) on the four PBR kinds, schema 6 → 7; emissive texture deferred to workflow ⑦'s measured need. [ADR-0089](../adr/0089-emissive-material-parameter-range-composition-and-push-constant-placement.md) (`Accepted`). |
