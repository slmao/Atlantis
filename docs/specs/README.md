...
| 0040 | [Multi-Light Architecture](0040-multi-light-architecture.md) | Approved (2026-09-21, chat confirmation; reviewed in this Spec's own branch PR) | None yet — Plan drafting authorized | Not started | Spec 0036 workflow ②; widens the point-light cap 4 → 64 in one uniform buffer, froxel/clustered rejected-for-now with its reopening condition recorded. [ADR-0088](../adr/0088-frame-lighting-data-successor-structure-and-binding-strategy.md) (`Accepted`). Plan 0037 Ruling 8's photometric obligation reassigned to a future separate Spec. |
