...
[resource_lifetime.md](../architecture/resource_lifetime.md) already
...
- **Silently amend [specs/README.md](README.md)'s Candidate Spec Backlog
  ordering or
  [docs/project-blueprint.md](../project-blueprint.md)'s milestone
...
- **Unit tests:** GPU-independent bookkeeping and validation logic against
  ...
  [testing-strategy.md](../process/testing-strategy.md) layer 1. At
  minimum:
