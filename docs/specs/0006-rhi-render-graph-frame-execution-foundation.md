...
order"), which
[module_boundaries.md](../architecture/module_boundaries.md) also lists.
...
[module_boundaries.md](../architecture/module_boundaries.md) states:
...
- **Headless integration tests:** not applicable in
  [testing-strategy.md](../process/testing-strategy.md)'s current sense
...
- Whether `Device::createCommandList()`/`submit()` needs its own new
  ...
  but neither fits
  [testing-strategy.md](../process/testing-strategy.md)'s layer 1 or 2 as
