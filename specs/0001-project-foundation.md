...
deferred — [ci-strategy.md](../docs/process/ci-strategy.md)). `src/` and
...
- No CI pipeline — still blocked on the build-system/dependency decisions this
  Spec identifies but does not finalize ([ci-strategy.md](../docs/process/ci-strategy.md)).
...
- Whether the dependency-management decision also settles the CI
  dependency-management question in [ci-strategy.md](../docs/process/ci-strategy.md)
