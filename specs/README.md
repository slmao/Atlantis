...
| 0033 | [Documentation Lifecycle and Historical Compaction](0033-documentation-lifecycle-and-compaction.md) | Approved | [Plan 0033](../plans/0033-documentation-lifecycle-and-compaction.md) ([PR #143](https://github.com/slmao/Atlantis/pull/143) merged; header stale) | In progress | Follow-up to 0004; guidance/templates, registry, and 0004 pilot only. |
