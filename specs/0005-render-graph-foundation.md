...
- Producer-to-reader dependency edges derived automatically from declared
  ...
  [render_graph/README.md](../docs/render_graph/README.md)'s "ordering derived
...
[module_boundaries.md](../docs/architecture/module_boundaries.md). No RHI
...
[overview.md](../docs/architecture/overview.md) and
[module_boundaries.md](../docs/architecture/module_boundaries.md): depends on
...
[render_graph/README.md](../docs/render_graph/README.md)'s long-term "Built on
