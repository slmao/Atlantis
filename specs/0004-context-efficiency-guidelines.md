...
The [documentation structure](../docs/README.md) intentionally separates
...
This formalizes the [blueprint](../docs/project-blueprint.md)'s existing
...
- **T4:** Record individual Spec/Plan Human Review sign-offs before approval,
  through reviewed merges under [Git workflow](../docs/process/git-workflow.md).
