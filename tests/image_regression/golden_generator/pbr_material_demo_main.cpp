...
// lighting_demo_main.cpp's own exact structure (Plan 0023 Milestone 8).
// ADR-0042's own two-phase golden capture process, matching every prior
// golden generator in this directory: this tool is only ever run
...
// pbr_material_demo_scene's own cooked paths and all three built-in
// shader pairs -- every value below comes from a configure-time
