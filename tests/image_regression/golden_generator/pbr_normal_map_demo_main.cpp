...
int main(int argc, char** argv) {
  ...
  if (argc != 2) {
    ATLANTIS_LOG_ERROR("usage: atlantis_image_regression_pbr_normal_map_demo_golden_generator <golden-name>");
    ATLANTIS_LOG_ERROR(
        "  e.g.: atlantis_image_regression_pbr_normal_map_demo_golden_generator "
        "pbr_normal_map_demo/pbr_normal_map_demo_512x512_rgba8unorm");
    return 2;
  }
