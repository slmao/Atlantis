...
int main(int argc, char** argv) {
  ...
  if (argc != 2) {
    ATLANTIS_LOG_ERROR("usage: atlantis_image_regression_bc7_dual_quad_golden_generator <golden-name>");
    ATLANTIS_LOG_ERROR(
        "  e.g.: atlantis_image_regression_textured_quad_golden_generator "
        "bc7_dual_quad/bc7_dual_quad_512x512_rgba8unorm");
    return 2;
  }
  ...
  // Spec 0038/Plan 0038 Milestone 3b: the BC7 dual-quad variant -- the
  // same fixture, shaders, meshes, and render path as textured_quad_main,
  // re-pointed at the two Bc7-layout fixtures (Bc7Unorm/Bc7Srgb formats).
