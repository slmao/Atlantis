...
// integrated_showcase_demo_main.cpp's own exact structure (Plan 0029
// Section P19). ADR-0042's own two-phase golden capture process: this
// Milestone only ever runs this tool to produce a *candidate*
// PNG/sidecar for human review -- neither file is committed by this
...
[[nodiscard]] BootstrapConfig buildConfig() {
  ...
  // bloom= group (the fixture forwards the BloomInput).
