...
struct MaterialDemoFixture {
  ...
  // colorFormat (kMaterialDemoColorFormat below) is Rgba8Unorm and
  // never changes at runtime -- only the UNORM output-transform variant
  // is ever loaded/built, once, at construction.
